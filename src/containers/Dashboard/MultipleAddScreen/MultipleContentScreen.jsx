...
class UserManagement extends Component {
    ...
    onEditorStateChange = (editorState) => {
        console.log("style", draftToHtml(convertToRaw(editorState.getCurrentContent())))
        ...
        console.log("object", convertFromRaw(convertToRaw(editorState.getCurrentContent())))
        this.setState({
            editorState,
                    ...
                    <div className="dash-wrapper">
                        <div className="row dash-session-header">
                            <div className="col-md-8">
                                <div className="session-title">{_.get(this.state, 'title', '')}</div>
                                <div className="session-sub-title">{_.get(this.state, 'sub_title', '')}</div>
                            </div>
